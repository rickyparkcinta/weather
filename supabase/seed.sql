insert into public.cities (slug, name, country, country_code, region, lat, lon, timezone, population, importance_score)
values
  ('new-york', 'New York', 'United States', 'US', 'North America', 40.7128, -74.0060, 'America/New_York', 18804000, 99),
  ...
  ('seoul', 'Seoul', 'South Korea', 'KR', 'Asia', 37.5665, 126.9780, 'Asia/Seoul', 9963000, 97),
  ...
  ('berlin', 'Berlin', 'Germany', 'DE', 'Europe', 52.5200, 13.4050, 'Europe/Berlin', 3571000, 92),
  ...
  ('mumbai', 'Mumbai', 'India', 'IN', 'Asia', 19.0760, 72.8777, 'Asia/Kolkata', 21297000, 94),
