...
{ "error": "Ingestion run failed", "details": "Supabase error message" }`
      ...
      },
      {
        ...
        description: "The Supabase schema stores normalized records, while the map API publishes forecast, market, and signal layers with confidence, freshness, probability-gap, and signal state fields.",
        blocks: [
          {
            kind: "table",
